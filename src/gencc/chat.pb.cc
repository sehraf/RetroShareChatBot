      ...
      case 10: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_participating_friends:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->participating_friends(this->participating_friends_size() - 1).data(),
            this->participating_friends(this->participating_friends_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_nicknames:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            ...
            this->nicknames(this->nicknames_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 3: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_invited_friends:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->invited_friends(this->invited_friends_size() - 1).data(),
            this->invited_friends(this->invited_friends_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_lobby_ids:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->lobby_ids(this->lobby_ids_size() - 1).data(),
            this->lobby_ids(this->lobby_ids_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
