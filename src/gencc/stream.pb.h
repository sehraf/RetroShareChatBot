...
class StreamDesc : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_file(::rsctrl::stream::StreamFileDetail* file);
  ...
  inline void set_allocated_voip(::rsctrl::stream::StreamVoipDetail* voip);
...
class StreamData : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_send_time(::rsctrl::core::Timestamp* send_time);
  ...
  inline void set_allocated_stream_data(::std::string* stream_data);
...
class ResponseStreamData : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_data(::rsctrl::stream::StreamData* data);
...
inline void StreamFileDetail::set_allocated_file(::rsctrl::core::File* file) {
  delete file_;
  file_ = file;
  if (file) {
    set_has_file();
...
inline void StreamVoipDetail::set_allocated_peer_id(::std::string* peer_id) {
  if (peer_id_ != &::google::protobuf::internal::kEmptyString) {
    delete peer_id_;
  }
  if (peer_id) {
...
inline void StreamDesc::set_stream_type(::rsctrl::stream::StreamType value) {
  assert(::rsctrl::stream::StreamType_IsValid(value));
  set_has_stream_type();
  stream_type_ = value;
}
...
inline void StreamDesc::set_stream_state(::rsctrl::stream::StreamState value) {
  assert(::rsctrl::stream::StreamState_IsValid(value));
...
inline void StreamDesc::set_allocated_file(::rsctrl::stream::StreamFileDetail* file) {
  delete file_;
  file_ = file;
  if (file) {
    set_has_file();
...
inline void StreamDesc::set_allocated_voip(::rsctrl::stream::StreamVoipDetail* voip) {
  delete voip_;
  voip_ = voip;
  if (voip) {
    set_has_voip();
...
inline void StreamData::set_allocated_send_time(::rsctrl::core::Timestamp* send_time) {
  delete send_time_;
...
inline void StreamData::set_allocated_stream_data(::std::string* stream_data) {
  if (stream_data_ != &::google::protobuf::internal::kEmptyString) {
    delete stream_data_;
  }
  if (stream_data) {
...
inline void RequestStartFileStream::set_allocated_file(::rsctrl::core::File* file) {
  delete file_;
  file_ = file;
  if (file) {
    set_has_file();
...
inline void ResponseStreamDetail::set_allocated_status(::rsctrl::core::Status* status) {
  delete status_;
  status_ = status;
  if (status) {
    set_has_status();
...
inline void RequestControlStream::set_action(::rsctrl::stream::RequestControlStream_StreamAction value) {
  assert(::rsctrl::stream::RequestControlStream_StreamAction_IsValid(value));
  set_has_action();
  action_ = value;
}
...
inline void ResponseStreamData::set_allocated_status(::rsctrl::core::Status* status) {
  delete status_;
  status_ = status;
  if (status) {
    set_has_status();
...
inline void ResponseStreamData::set_allocated_data(::rsctrl::stream::StreamData* data) {
  delete data_;
  data_ = data;
  if (data) {
    set_has_data();
