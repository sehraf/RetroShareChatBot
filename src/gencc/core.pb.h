...
class Location : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_localaddr(::rsctrl::core::IpAddr* localaddr);
  ...
  inline void set_allocated_extaddr(::rsctrl::core::IpAddr* extaddr);
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_gpg_id(::std::string* gpg_id);
...
inline void Status::set_code(::rsctrl::core::Status_StatusCode value) {
  assert(::rsctrl::core::Status_StatusCode_IsValid(value));
  set_has_code();
  code_ = value;
}
...
inline void IpAddr::set_allocated_addr(::std::string* addr) {
  if (addr_ != &::google::protobuf::internal::kEmptyString) {
    delete addr_;
  }
  if (addr) {
...
inline void Location::set_allocated_ssl_id(::std::string* ssl_id) {
  if (ssl_id_ != &::google::protobuf::internal::kEmptyString) {
    delete ssl_id_;
  }
  if (ssl_id) {
...
inline void Location::set_allocated_localaddr(::rsctrl::core::IpAddr* localaddr) {
  delete localaddr_;
...
inline void Location::set_allocated_extaddr(::rsctrl::core::IpAddr* extaddr) {
  delete extaddr_;
  extaddr_ = extaddr;
  if (extaddr) {
    set_has_extaddr();
...
inline void Person::set_allocated_gpg_id(::std::string* gpg_id) {
  if (gpg_id_ != &::google::protobuf::internal::kEmptyString) {
    delete gpg_id_;
  }
  if (gpg_id) {
...
inline void Person::set_relation(::rsctrl::core::Person_Relationship value) {
  assert(::rsctrl::core::Person_Relationship_IsValid(value));
  set_has_relation();
  relation_ = value;
}
...
inline void Dir::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
...
inline void Dir::set_allocated_path(::std::string* path) {
  if (path_ != &::google::protobuf::internal::kEmptyString) {
    delete path_;
  }
  if (path) {
...
inline void SystemStatus::set_net_status(::rsctrl::core::SystemStatus_NetCode value) {
  assert(::rsctrl::core::SystemStatus_NetCode_IsValid(value));
  set_has_net_status();
  net_status_ = value;
}
...
inline void SystemStatus::set_allocated_msg(::std::string* msg) {
  if (msg_ != &::google::protobuf::internal::kEmptyString) {
    delete msg_;
  }
  if (msg) {
...
inline void Bandwidth::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
